...
The course packet will be available here when we begin the course. It will contain PDFs of the slides for the course together with code for almost all of the graphs we will draw, and any additional material (such as examples arising from questions, office-hour exercises, and so on) that we cover during the course. 
