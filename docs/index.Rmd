...
description: |
  A Course with R and ggplot2.
author:
- name: Kieran Healy
  url: https://kieranhealy.org
date: "`Code Horizons, June 2021`"
...
## A 4-Day Remote Seminar at [Code Horizons](https://codehorizons.com/Seminars/data-visualization/).
...
- Begin by installing R (<http://cloud.r-project.org>). Choose the version appropriate for your computing platform:
  - [macOS with an Intel processor](https://cloud.r-project.org/bin/macosx/base/R-4.1.0.pkg)
  - [macOS with an Apple Silicon (M1) processor](https://cloud.r-project.org/bin/macosx/big-sur-arm64/base/R-4.1.0-arm64.pkg)
...
The [course packet](https://github.com/kjhealy/dataviz_0621/archive/refs/heads/main.zip) is an RStudio project containing PDFs of the slides for the course together with code for almost all of the graphs we will draw, and some additional datasets and other material. After you have installed R and RStudio, [download the course packet](https://github.com/kjhealy/dataviz_0621/archive/refs/heads/main.zip) and uncompress it on your computer. Double-clicking the file named `dataviz.Rproj` should launch the project in RStudio.
