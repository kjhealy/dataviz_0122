...
This repo is also the course packet. It contains the course material, data, slides, and code for the graphs we will draw. It's an RStudio project. Clone it with Git or [download it as a zip file](https://github.com/kjhealy/dataviz_0122/archive/refs/heads/main.zip) and decompress it. To launch the project, double-click on `dataviz.Rproj` and RStudio will open with this project ready to go. 
