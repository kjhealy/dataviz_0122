...
This packet contains the course material, data, slides, and code for the graphs we will draw. It's an RStudio project. To launch it, double-click on `dataviz.Rproj` and RStudio will open with this project ready to go. 
...
An RMarkdown document for quickly working on examples or queries that come up in class.
