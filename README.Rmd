...
date: "`[Code Horizons](https://codehorizons.com/Seminars/data-visualization/), June 2021`"
output: md_document
...
- `scratch.Rmd`is where I'll work on examples or queries that come up in class.
